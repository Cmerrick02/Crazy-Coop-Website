...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
				...
				if(isset($_SESSION['username'])){
					echo '<li class="active"><a href="account.php"><span class="glyphicon glyphicon-user"></span> '.$_SESSION['username'].'</a></li>';
	...
	<div class="container text-center">
        ...
        <h3>Preferences</h3><br><br>
		<form action="dark.php" method="POST">
		<p>Dark Mode: 
		<input type="submit" class="btn btn-primary btn-md" value="Change"></p>
		</form>
        <br>
        <br>
        <h3>Account Settings</h3><br><br>
        <p>Change your Password: <a href="password.php" class="btn btn-primary btn-md">Here</a></p>
        <br>
        <br>
        <p>Change your Username: <a href="username.php" class="btn btn-primary btn-md">Here</a></p>
    </div>
