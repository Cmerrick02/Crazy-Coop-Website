...
<body>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="candleshop.php"><b>Candles</b></a></li>
    ...
    <div class="row">
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products WHERE id IN (4, 5, 6)');
          if($result === FALSE){
            die(mysql_error());
          }
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
			  ...
			  echo '<div class="panel-body"><img src="bigcandles" class="img-responsive" style="width:100%" alt="Image"></div>';
			  echo '<div class="panel-footer panel-custom">'.$obj->product_desc.'<br>$'.$obj->price.'<br>';
    ...
    <div class="row">
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM products WHERE id IN (7, 8, 9, 10)');
          if($result === FALSE){
            die(mysql_error());
          }
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
			  ...
			  echo '<div class="panel panel-danger">';
			  echo '<div class="panel-heading"><strong>'.$obj->product_name.'</strong></div>';
			  echo '<div class="panel-body"><img src="smallcandles" class="img-responsive" style="width:100%" alt="Image"></div>';
			  echo '<div class="panel-footer panel-custom">'.$obj->product_desc.'<br>$'.$obj->price.'<br>';
