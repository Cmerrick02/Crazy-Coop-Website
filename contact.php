...
<body>
	...
	<div class="container">
        ...
        <form method="POST" class="form-horizontal" action="contmail.php" id="contact">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
            <textarea class="form-control" rows="5" id="comment" placeholder="Enter comments/questions here" name="text" form="contact"></textarea>
            </div>
            </div>
