...
<body>
	...
	<div class="container">
        <h3><strong>Change Username</strong></h3>
		<br>
		<br>
		<h2>Note: Changing your username will log you out!</h2>
		<br>
		<br>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			<input type="text" class="form-control" id="newusername" placeholder="New Username Here" name="newusername">
			</div>
			</div>
